...
#   --studyFile /gpfs/helios/home/kerimov/alasoo_lab/plotgen/input/MacroMap/MacroMap_ge_input.tsv\
#   --outdir /gpfs/helios/projects/eQTLCatalogue/coverage_plots/MacroMap_ge
